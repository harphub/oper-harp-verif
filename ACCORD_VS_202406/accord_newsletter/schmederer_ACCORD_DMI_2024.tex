...
%For the snow cover verification presented
%Data used: - CARRA1 West domain in regular lat lon grid (fraction of snow cover). - Snow cover data (probability of snow) provided by MetNorway
